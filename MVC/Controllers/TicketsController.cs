...
namespace MVC.Controllers
{
    public class TicketsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "TicketID,Placa,DataEntrada,DataSaida,SegundaVia,MotivoLiberacaoGeral,MotivoSegundaVia,Valor,Liberado,VagaID")] Ticket ticket)
        {
